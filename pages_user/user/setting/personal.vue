	...
	<view class="container">
		<view class="dflex-c pos-r margin-bottom margin-top">
			<view class="portrait-box" @click="changeHeadPic">
				<image class="border-radius-c" :src="headImageLocalPath || (userData && userData.member_headimg)  || '/static/images/user/default_head.jpg'">
				</image>
			</view>
	...
	export default {
		...
		methods:{
			...
			async submit() {
				...
				if (!this.userData.member_nickname) {
					this.$api.msg('请输入昵称');
					return;
				}

...
<script>
  ...
  import {
	...
	export default {
      ...
      islogin(e) {
				console.log('islogin changed: ', this.islogin, e)
      ...
      if (!this.islogin && !this.redirectToLogin) {
  ...
  onShow() {
	  ...
	  console.log('getCurrentPages，', pages, currentPage, currentPagePath);

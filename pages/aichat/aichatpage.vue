<template>
	<view class="y-wrap" :style="'--bottom-height:' + bottomHeight">
		<scroll-view class="y-wrap_message_content" id="scrollBox" scroll-y :scroll-into-view="scrollToId"
			:refresher-enabled="useRefresh" :refresher-threshold="100" :refresher-triggered="triggered"
			scroll-with-animation refresher-default-style="white" refresher-background="#F2F2F2"
